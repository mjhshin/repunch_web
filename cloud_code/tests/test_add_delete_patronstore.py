...
def test_add_delete_patronstore():
    ...
    def test_2():
        return store.get("patronStores", count=1, limit=0,
            objectId=test.extras["patron_store"].objectId) == 1
    
    ##########  PatronStore's Patron pointer is set
    def test_3():
        return test.extras["patron_store"].Patron == patron.objectId
    
    ##########  PatronStore's Store pointer is set 
    def test_4():
        return test.extras["patron_store"].Store == store.objectId
    
    ##########  PatronStore's all_time_punches is set to 0 
    def test_5():
        return test.extras["patron_store"].all_time_punches == 0
    
    ##########  PatronStore's punch_count is set to 0 
    def test_6():
        return test.extras["patron_store"].punch_count == 0
    ...
    def test_12():
        return patron.get("patronStores", count=1, limit=0,
            objectId=test.extras["patron_store"].objectId) == 0
