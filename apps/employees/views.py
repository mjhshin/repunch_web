...
def edit(request, employee_id):
    ...
    if request.method == 'POST': # If the form has been submitted...
        form = EmployeeForm(request.POST, instance=employee) # A form bound to the POST data
...
def delete(request, employee_id):
    ...
    employee.delete()
    return redirect(reverse('employees_index')+ "?%s" % urllib.urlencode({'success': 'Employee has been deleted.'}))
...
def approve(request, employee_id):
    ...
    return redirect(reverse('employees_index')+ "?show_pending&%s" % urllib.urlencode({'success': 'Employee has been approved.'}))
...
def deny(request, employee_id):
    ...
    return redirect(reverse('employees_index')+ "?show_pending&%s" % urllib.urlencode({'success': 'Employee has been denied.'}))
